...
#
# Generated by Vivado on Thu Jan 19 16:21:30 +0800 2023
...
# Script info
echo -e "clk_wiz_1.sh - Script generated by export_simulation (Vivado v2019.1 (64-bit)-id)\n"
...
compile()
{
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../ipstatic" \
    "$ref_dir/../../../../eth_ddr3_hdmi.srcs/sources_1/ip/clk_wiz_1/clk_wiz_1_clk_wiz.v" \
    "$ref_dir/../../../../eth_ddr3_hdmi.srcs/sources_1/ip/clk_wiz_1/clk_wiz_1.v" \
  2>&1 | tee -a vlogan.log
